...
(BE / "runtime" / "prober.py").write_text('''"""Background health prober.
...
print("  [OK] backend/app/runtime/prober.py")

(ROOT / "tests" / "test_prober.py").write_text('''import os, time, asyncio
...
''', encoding="utf-8", newline="\n")
print("  [OK] tests/test_prober.py")

import ast
for f in ["backend/app/runtime/prober.py", "tests/test_prober.py"]:
