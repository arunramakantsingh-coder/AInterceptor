...
print("  [OK] chat_any.py rewritten")
...
git(["add","-A"])
r = git(["commit","-m","fix(cli): rewrite chat_any with robust runtime discovery"])
print(r.stdout.strip() or r.stderr.strip())

print()
print("Test in this shell:")
print('  $env:Path += ";C:\\Projects\\AInterceptor-M1.5\\bin"')
print("  deepseek")
